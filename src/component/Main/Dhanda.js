...
import Selfmade from "../Audio/selfmade.mp3";
import blackandwhite from "../Audio/blackandwhite.mp3";
import SignedTogod from "../Audio/signedtogod.mp3";
import BrownShortie from "../Audio/BrownShortie.mp3";
const App = () => {
  ...
  const songs = [
    { name: "Panjab", file: panjab },
    { name: "Self Made", file: Selfmade },
    { name: "B & W", file: blackandwhite },
    { name: "Signed To God", file: SignedTogod },
    { name: "Brown Shortie", file: BrownShortie },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-gray-900 text-white">
      <h1 className="text-4xl font-bold mt-10">Dhanda Nyoliwala </h1>
